...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        TerminalSession.RXIN_ENV_OVERRIDE = RxinSandbox.getShinitPath(this)
        TerminalSession.RXIN_PATH_OVERRIDE = if (hasRoot) "/data/local/tmp/RXin/bin" else RxinSandbox.getPathFragment(this)
    }
